...
class TSN(nn.Module):
    def __init__(self, num_class=400, num_segments=4, modality='RGB',
    ...
    def _prepare_base_model(self, base_model):
        ...
        if 'resnet' in base_model:
            ...
            if self.non_local:
                ...
                from models.non_local import make_non_local
            ...
            from models.mobilenet_v2 import mobilenet_v2, InvertedResidual
